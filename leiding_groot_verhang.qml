...
<qgis simplifyLocal="1" labelsEnabled="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" readOnly="0" version="3.8.0-Zanzibar" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" minScale="1e+08" simplifyDrawingHints="1" maxScale="0" simplifyMaxScale="1">
  ...
  <aliases>
    ...
    <alias name="" index="1" field="verhang"/>
    <alias name="" index="2" field="pipe_sewerage_type"/>
    <alias name="" index="3" field="pipe_cross_section_definition_id"/>
    <alias name="" index="4" field="pipe_material"/>
    <alias name="" index="5" field="pipe_display_name"/>
    ...
    <alias name="" index="9" field="pipe_zoom_category"/>
    <alias name="" index="10" field="pipe_id"/>
    <alias name="" index="11" field="pipe_code"/>
    <alias name="" index="12" field="pipe_profile_num"/>
    <alias name="" index="13" field="pipe_friction_value"/>
    <alias name="" index="14" field="pipe_friction_type"/>
    <alias name="" index="15" field="pipe_dist_calc_points"/>
    <alias name="" index="16" field="pipe_original_length"/>
    <alias name="" index="17" field="pipe_connection_node_start_id"/>
    <alias name="" index="18" field="pipe_connection_node_end_id"/>
    <alias name="" index="19" field="def_id"/>
    <alias name="" index="20" field="def_shape"/>
    <alias name="" index="21" field="def_width"/>
    <alias name="" index="22" field="def_height"/>
    <alias name="" index="23" field="def_code"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" notnull_strength="0" constraints="0" field="verhang"/>
