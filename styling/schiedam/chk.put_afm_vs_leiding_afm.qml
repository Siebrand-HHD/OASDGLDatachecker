...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" readOnly="0" simplifyLocal="1" minScale="1e+08" version="3.4.15-Madeira" simplifyDrawingTol="1" simplifyAlgorithm="0">
  ...
  <fieldConfiguration>
    ...
    <field name="grootste_leiding_afmeting">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="4" field="grootste_put_afmeting"/>
    <alias name="" index="5" field="grootste_leiding_afmeting"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="grootste_put_afmeting"/>
    <default expression="" applyOnUpdate="0" field="grootste_leiding_afmeting"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="grootste_put_afmeting"/>
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="grootste_leiding_afmeting"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="grootste_leiding_afmeting"/>
