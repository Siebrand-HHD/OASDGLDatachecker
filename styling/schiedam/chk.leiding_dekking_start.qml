...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" readOnly="0" simplifyLocal="1" minScale="1e+08" version="3.4.15-Madeira" simplifyDrawingTol="1" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias name="" index="4" field="bob_beginpunt"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="bob_beginpunt"/>
    <default expression="" applyOnUpdate="0" field="hoogte_profiel"/>
    <default expression="" applyOnUpdate="0" field="bovenkant_leiding"/>
    <default expression="" applyOnUpdate="0" field="put_maaiveldhoogte"/>
    <default expression="" applyOnUpdate="0" field="ahn_maaiveldhoogte"/>
    <default expression="" applyOnUpdate="0" field="dekking_put_maaiveldhoogte"/>
    <default expression="" applyOnUpdate="0" field="dekking_ahn_maaiveldhoogte"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="bob_beginpunt"/>
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="hoogte_profiel"/>
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="bovenkant_leiding"/>
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="put_maaiveldhoogte"/>
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="ahn_maaiveldhoogte"/>
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="dekking_put_maaiveldhoogte"/>
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="dekking_ahn_maaiveldhoogte"/>
