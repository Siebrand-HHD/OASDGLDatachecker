...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" readOnly="0" simplifyLocal="1" minScale="1e+08" version="3.4.15-Madeira" simplifyDrawingTol="1" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias name="" index="5" field="bob_beginpunt"/>
    <alias name="" index="6" field="bob_eindpunt"/>
    <alias name="" index="7" field="hoogte_verschil_bob"/>
    <alias name="" index="8" field="lengte_leiding"/>
    <alias name="" index="9" field="verhang"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="hoogte_verschil_bob"/>
    <default expression="" applyOnUpdate="0" field="lengte_leiding"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="hoogte_verschil_bob"/>
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="lengte_leiding"/>
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="verhang"/>
