...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" readOnly="0" simplifyLocal="1" minScale="1e+08" version="3.4.15-Madeira" simplifyDrawingTol="1" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias name="" index="5" field="typeinzameling"/>
    <alias name="" index="6" field="bob_beginpunt"/>
    <alias name="" index="7" field="bob_eindpunt"/>
    <alias name="" index="8" field="materiaal"/>
    <alias name="" index="9" field="vormprofiel"/>
    <alias name="" index="10" field="breedte"/>
    <alias name="" index="11" field="hoogte"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="typeinzameling"/>
    ...
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="materiaal"/>
