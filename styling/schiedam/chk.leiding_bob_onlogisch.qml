...
<qgis labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="1" maxScale="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" readOnly="0" simplifyLocal="1" minScale="1e+08" version="3.4.15-Madeira" simplifyDrawingTol="1" simplifyAlgorithm="0">
  ...
  <aliases>
    ...
    <alias name="" index="3" field="threedi_start_id"/>
    <alias name="" index="4" field="threedi_end_id"/>
    <alias name="" index="5" field="beginpunt"/>
    <alias name="" index="6" field="eindpunt"/>
    <alias name="" index="7" field="bob_beginpunt"/>
    <alias name="" index="8" field="bob_eindpunt"/>
    <alias name="" index="9" field="hoogte_profiel"/>
    <alias name="" index="10" field="bericht"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="threedi_start_id"/>
    <default expression="" applyOnUpdate="0" field="threedi_end_id"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="threedi_start_id"/>
    <constraint constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0" field="threedi_end_id"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="threedi_start_id"/>
    <constraint desc="" exp="" field="threedi_end_id"/>
