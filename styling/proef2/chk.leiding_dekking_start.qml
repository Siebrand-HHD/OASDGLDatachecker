...
<qgis labelsEnabled="0" simplifyDrawingHints="1" maxScale="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="0" version="3.8.0-Zanzibar" simplifyLocal="1" readOnly="0">
  ...
  <renderer-v2 attr="if( &quot;dekking_put_maaiveldhoogte&quot; IS NULL, &quot;dekking_ahn_maaiveldhoogte&quot; , &quot;dekking_put_maaiveldhoogte&quot; )" symbollevels="0" enableorderby="0" graduatedMethod="GraduatedColor" forceraster="0" type="graduatedSymbol">
    <ranges>
      <range upper="0.000000000000000" lower="-10.000000000000000" label="leiding boven maaiveld" render="true" symbol="0"/>
      <range upper="0.200000000000000" lower="0.000000000000000" label="leiding 0 tot 20cm onder maaiveld" render="true" symbol="1"/>
      <range upper="0.400000000000000" lower="0.200000000000000" label="leiding 20 tot 40cm onder maaiveld" render="true" symbol="2"/>
      <range upper="0.600000000000000" lower="0.400000000000000" label="leiding 40 tot 60cm onder maaiveld" render="true" symbol="3"/>
      <range upper="0.800000000000000" lower="0.600000000000000" label="leiding 60 tot 80cm onder maaiveld" render="true" symbol="4"/>
    </ranges>
    <symbols>
      ...
      <symbol name="1" force_rhr="0" clip_to_extent="1" alpha="1" type="line">
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="212,32,32,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.66"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol name="2" force_rhr="0" clip_to_extent="1" alpha="1" type="line">
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="252,112,80,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.66"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol name="3" force_rhr="0" clip_to_extent="1" alpha="1" type="line">
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="253,190,165,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.66"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <aliases>
    ...
    <alias name="" field="bob_beginpunt" index="4"/>
    <alias name="" field="hoogte_profiel" index="5"/>
    <alias name="" field="bovenkant_leiding" index="6"/>
    <alias name="" field="put_maaiveldhoogte" index="7"/>
    <alias name="" field="ahn_maaiveldhoogte" index="8"/>
    <alias name="" field="dekking_put_maaiveldhoogte" index="9"/>
    <alias name="" field="dekking_ahn_maaiveldhoogte" index="10"/>
  ...
  <constraints>
    ...
    <constraint field="hoogte_profiel" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="bovenkant_leiding" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    ...
    <constraint field="dekking_put_maaiveldhoogte" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="dekking_ahn_maaiveldhoogte" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
