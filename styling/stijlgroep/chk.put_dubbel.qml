...
<qgis styleCategories="AllStyleCategories" simplifyDrawingHints="1" version="3.8.0-Zanzibar" simplifyLocal="1" maxScale="0" labelsEnabled="0" readOnly="0" simplifyMaxScale="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyDrawingTol="1">
  ...
  <defaults>
    ...
    <default field="threedi_connection_node_id" expression="" applyOnUpdate="0"/>
    <default field="aantal" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="threedi_connection_node_id" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="aantal" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="status" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="id" desc="" exp=""/>
    <constraint field="threedi_connection_node_id" desc="" exp=""/>
    <constraint field="aantal" desc="" exp=""/>
