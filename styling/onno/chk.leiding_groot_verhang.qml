...
<qgis hasScaleBasedVisibilityFlag="0" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" minScale="0" simplifyAlgorithm="0" version="3.8.0-Zanzibar" maxScale="0" labelsEnabled="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" simplifyDrawingTol="1">
  ...
  <constraints>
    ...
    <constraint field="bob_beginpunt" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="bob_eindpunt" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="hoogte_verschil_bob" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="lengte_leiding" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="verhang" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="bob_beginpunt" exp="" desc=""/>
    <constraint field="bob_eindpunt" exp="" desc=""/>
    <constraint field="hoogte_verschil_bob" exp="" desc=""/>
    <constraint field="lengte_leiding" exp="" desc=""/>
