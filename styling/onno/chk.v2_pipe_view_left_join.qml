...
<qgis hasScaleBasedVisibilityFlag="0" simplifyLocal="1" readOnly="0" simplifyDrawingHints="1" minScale="1e+08" simplifyAlgorithm="0" version="3.8.0-Zanzibar" maxScale="0" labelsEnabled="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" simplifyDrawingTol="1">
  <flags>
  ...
  <aliases>
    ...
    <alias field="pipe_code" name="" index="3"/>
    <alias field="pipe_profile_num" name="" index="4"/>
    <alias field="pipe_sewerage_type" name="" index="5"/>
    <alias field="pipe_calculation_type" name="" index="6"/>
    <alias field="pipe_invert_level_start_point" name="" index="7"/>
    <alias field="pipe_invert_level_end_point" name="" index="8"/>
    <alias field="pipe_cross_section_definition_id" name="" index="9"/>
    <alias field="pipe_friction_value" name="" index="10"/>
    <alias field="pipe_friction_type" name="" index="11"/>
    <alias field="pipe_dist_calc_points" name="" index="12"/>
    <alias field="pipe_material" name="" index="13"/>
    <alias field="pipe_original_length" name="" index="14"/>
    <alias field="pipe_zoom_category" name="" index="15"/>
    <alias field="pipe_connection_node_start_id" name="" index="16"/>
    <alias field="pipe_connection_node_end_id" name="" index="17"/>
    <alias field="def_id" name="" index="18"/>
    <alias field="def_shape" name="" index="19"/>
  ...
  <constraints>
    ...
    <constraint field="pipe_id" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_display_name" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_code" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_profile_num" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_sewerage_type" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_calculation_type" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_invert_level_start_point" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_invert_level_end_point" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_cross_section_definition_id" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_friction_value" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_friction_type" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_dist_calc_points" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_material" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_original_length" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_zoom_category" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_connection_node_start_id" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="pipe_connection_node_end_id" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="def_id" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="def_shape" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="def_width" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="def_height" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint field="def_code" notnull_strength="0" constraints="0" exp_strength="0" unique_strength="0"/>
  </constraints>
