...
<qgis minScale="1e+08" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" readOnly="0" version="3.8.0-Zanzibar" labelsEnabled="0" simplifyLocal="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <defaults>
    ...
    <default field="hoogte_verschil_bob" expression="" applyOnUpdate="0"/>
    <default field="lengte_leiding" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" field="bob_beginpunt" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="bob_eindpunt" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="hoogte_verschil_bob" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="lengte_leiding" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="verhang" notnull_strength="0" unique_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="bob_beginpunt"/>
    <constraint exp="" desc="" field="bob_eindpunt"/>
    <constraint exp="" desc="" field="hoogte_verschil_bob"/>
    <constraint exp="" desc="" field="lengte_leiding"/>
    <constraint exp="" desc="" field="verhang"/>
