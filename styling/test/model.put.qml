...
=======
    ...
    <alias field="vorm" index="3" name=""/>
    <alias field="breedte" index="4" name=""/>
    <alias field="lengte" index="5" name=""/>
    <alias field="typeknooppunt" index="6" name=""/>
    <alias field="bodemhoogte" index="7" name=""/>
    <alias field="maaiveldhoogte" index="8" name=""/>
>>>>>>> siebrand-gisib
  </aliases>
...
=======
    ...
    <constraint exp_strength="0" field="vorm" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="breedte" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="lengte" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="typeknooppunt" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="bodemhoogte" unique_strength="0" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="maaiveldhoogte" unique_strength="0" constraints="0" notnull_strength="0"/>
>>>>>>> siebrand-gisib
  </constraints>
