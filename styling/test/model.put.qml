...
<qgis minScale="1e+08" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" readOnly="0" version="3.8.0-Zanzibar" labelsEnabled="0" simplifyLocal="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <aliases>
    ...
    <alias name="" index="3" field="vorm"/>
    <alias name="" index="4" field="breedte"/>
    <alias name="" index="5" field="lengte"/>
    <alias name="" index="6" field="typeknooppunt"/>
    <alias name="" index="7" field="bodemhoogte"/>
    <alias name="" index="8" field="maaiveldhoogte"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="vorm" expression="" applyOnUpdate="0"/>
    <default field="breedte" expression="" applyOnUpdate="0"/>
    <default field="lengte" expression="" applyOnUpdate="0"/>
    <default field="typeknooppunt" expression="" applyOnUpdate="0"/>
    <default field="bodemhoogte" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" field="vorm" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    ...
    <constraint constraints="0" field="typeknooppunt" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="bodemhoogte" notnull_strength="0" unique_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="vorm"/>
    <constraint exp="" desc="" field="breedte"/>
    <constraint exp="" desc="" field="lengte"/>
    <constraint exp="" desc="" field="typeknooppunt"/>
    <constraint exp="" desc="" field="bodemhoogte"/>
