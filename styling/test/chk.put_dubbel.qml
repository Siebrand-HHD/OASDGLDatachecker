...
<qgis minScale="1e+08" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" readOnly="0" version="3.8.0-Zanzibar" labelsEnabled="0" simplifyLocal="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <aliases>
    ...
    <alias name="" index="1" field="threedi_connection_node_id"/>
    <alias name="" index="2" field="aantal"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" field="threedi_connection_node_id" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="aantal" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="status" notnull_strength="0" unique_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="id"/>
    <constraint exp="" desc="" field="threedi_connection_node_id"/>
    <constraint exp="" desc="" field="aantal"/>
