...
<qgis minScale="1e+08" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" readOnly="0" version="3.8.0-Zanzibar" labelsEnabled="0" simplifyLocal="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <constraints>
    ...
    <constraint constraints="0" field="threedi_ids" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    ...
    <constraint constraints="0" field="leidingen" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="type_leidingen" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="aantal_leidingen" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="status" notnull_strength="0" unique_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="id"/>
    <constraint exp="" desc="" field="threedi_ids"/>
    <constraint exp="" desc="" field="beginpunt"/>
    <constraint exp="" desc="" field="eindpunt"/>
    <constraint exp="" desc="" field="leidingen"/>
    <constraint exp="" desc="" field="type_leidingen"/>
    <constraint exp="" desc="" field="aantal_leidingen"/>
