...
<qgis minScale="1e+08" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" readOnly="0" version="3.8.0-Zanzibar" labelsEnabled="0" simplifyLocal="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <defaults>
    ...
    <default field="threedi_start_id" expression="" applyOnUpdate="0"/>
    <default field="threedi_end_id" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" field="threedi_start_id" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" field="threedi_end_id" notnull_strength="0" unique_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="threedi_start_id"/>
    <constraint exp="" desc="" field="threedi_end_id"/>
