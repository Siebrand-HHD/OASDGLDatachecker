...
<qgis labelsEnabled="0" simplifyDrawingHints="1" maxScale="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="0" version="3.8.0-Zanzibar" simplifyLocal="1" readOnly="0">
    ...
    <symbols>
      <symbol name="0" force_rhr="0" clip_to_extent="1" alpha="1" type="line">
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          ...
          <prop k="line_color" v="68,212,39,255"/>
  ...
  <aliases>
    ...
    <alias name="" field="vormprofiel" index="5"/>
    <alias name="" field="breedte" index="6"/>
    <alias name="" field="hoogte" index="7"/>
    <alias name="" field="bericht" index="8"/>
    <alias name="" field="status" index="9"/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint field="vormprofiel" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="breedte" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="hoogte" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
