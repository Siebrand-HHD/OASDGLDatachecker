...
<qgis labelsEnabled="0" simplifyDrawingHints="1" maxScale="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="0" version="3.8.0-Zanzibar" simplifyLocal="1" readOnly="0">
    ...
    <symbols>
      <symbol name="0" force_rhr="0" clip_to_extent="1" alpha="1" type="line">
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          ...
          <prop k="line_color" v="27,111,201,255"/>
  ...
  <aliases>
    ...
    <alias name="" field="threedi_ids" index="1"/>
    <alias name="" field="beginpunt" index="2"/>
    <alias name="" field="eindpunt" index="3"/>
    <alias name="" field="leidingen" index="4"/>
    <alias name="" field="type_leidingen" index="5"/>
    <alias name="" field="aantal_leidingen" index="6"/>
  ...
  <constraints>
    ...
    <constraint field="threedi_ids" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    ...
    <constraint field="leidingen" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="type_leidingen" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="aantal_leidingen" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
