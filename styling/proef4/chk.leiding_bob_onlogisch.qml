...
<qgis labelsEnabled="0" simplifyDrawingHints="1" maxScale="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="0" version="3.8.0-Zanzibar" simplifyLocal="1" readOnly="0">
    ...
    <symbols>
      <symbol name="0" force_rhr="0" clip_to_extent="1" alpha="1" type="line">
        <layer pass="0" locked="0" class="SimpleLine" enabled="1">
          ...
          <prop k="line_color" v="255,33,66,255"/>
  ...
  <aliases>
    ...
    <alias name="" field="threedi_start_id" index="3"/>
    <alias name="" field="threedi_end_id" index="4"/>
    <alias name="" field="beginpunt" index="5"/>
    <alias name="" field="eindpunt" index="6"/>
    <alias name="" field="bob_beginpunt" index="7"/>
    <alias name="" field="bob_eindpunt" index="8"/>
    <alias name="" field="hoogte_profiel" index="9"/>
    <alias name="" field="bericht" index="10"/>
  ...
  <constraints>
    ...
    <constraint field="threedi_start_id" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="threedi_end_id" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
