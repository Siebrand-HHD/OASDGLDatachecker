...
<qgis simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyAlgorithm="0" maxScale="0" version="3.8.0-Zanzibar" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="dekking"/>
    <default expression="" applyOnUpdate="0" field="dekking_mv"/>
    <default expression="" applyOnUpdate="0" field="bob_plus_hoogte"/>
    <default expression="" applyOnUpdate="0" field="model_maaiveld"/>
    <default expression="" applyOnUpdate="0" field="dem_maaiveld"/>
    <default expression="" applyOnUpdate="0" field="profiel_hoogte"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="dekking" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="dekking_mv" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="bob_plus_hoogte" exp_strength="0"/>
    ...
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="profiel_hoogte" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="dekking" exp="" desc=""/>
    <constraint field="dekking_mv" exp="" desc=""/>
    <constraint field="bob_plus_hoogte" exp="" desc=""/>
    <constraint field="model_maaiveld" exp="" desc=""/>
    <constraint field="dem_maaiveld" exp="" desc=""/>
    <constraint field="profiel_hoogte" exp="" desc=""/>
