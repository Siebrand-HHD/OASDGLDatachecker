...
<qgis simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyAlgorithm="0" maxScale="0" version="3.8.0-Zanzibar" readOnly="0" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <aliases>
    ...
    <alias name="" index="1" field="putdiepte"/>
    <alias name="" index="2" field="manh_bottom_level"/>
    <alias name="" index="3" field="manh_surface_level"/>
    <alias name="" index="4" field="manh_display_name"/>
    <alias name="" index="5" field="manh_shape"/>
    <alias name="" index="6" field="manh_width"/>
    <alias name="" index="7" field="manh_length"/>
    <alias name="" index="8" field="manh_manhole_indicator"/>
    <alias name="" index="9" field="manh_calculation_type"/>
    <alias name="" index="10" field="manh_drain_level"/>
    <alias name="" index="11" field="manh_zoom_category"/>
    <alias name="" index="12" field="node_initial_waterlevel"/>
    <alias name="" index="13" field="manh_id"/>
    <alias name="" index="14" field="manh_connection_node_id"/>
    <alias name="" index="15" field="node_id"/>
    <alias name="" index="16" field="node_storage_area"/>
    <alias name="" index="17" field="manh_code"/>
    <alias name="" index="18" field="node_code"/>
    <alias name="" index="19" field="manh_sediment_level"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default expression="" applyOnUpdate="0" field="id"/>
    <default expression="" applyOnUpdate="0" field="putdiepte"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" notnull_strength="0" field="putdiepte" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="putdiepte" exp="" desc=""/>
