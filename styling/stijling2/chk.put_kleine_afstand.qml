...
<qgis styleCategories="AllStyleCategories" simplifyDrawingHints="1" version="3.8.0-Zanzibar" simplifyLocal="1" maxScale="0" labelsEnabled="0" readOnly="0" simplifyMaxScale="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyDrawingTol="1">
  ...
  <constraints>
    ...
    <constraint field="rioolput_een" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="rioolput_twee" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="threedi_id_een" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="threedi_id_twee" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="afstand" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="status" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="id" desc="" exp=""/>
    <constraint field="rioolput_een" desc="" exp=""/>
    <constraint field="rioolput_twee" desc="" exp=""/>
    <constraint field="threedi_id_een" desc="" exp=""/>
    <constraint field="threedi_id_twee" desc="" exp=""/>
    <constraint field="afstand" desc="" exp=""/>
