...
<qgis minScale="1e+08" readOnly="0" version="3.8.0-Zanzibar" labelsEnabled="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1">
  ...
  <defaults>
    ...
    <default field="threedi_ids" expression="" applyOnUpdate="0"/>
    <default field="beginpunt" expression="" applyOnUpdate="0"/>
    <default field="eindpunt" expression="" applyOnUpdate="0"/>
    <default field="leidingen" expression="" applyOnUpdate="0"/>
    <default field="type_leidingen" expression="" applyOnUpdate="0"/>
    <default field="aantal_leidingen" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" field="threedi_ids" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    ...
    <constraint constraints="0" field="leidingen" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="type_leidingen" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="aantal_leidingen" notnull_strength="0" exp_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="status" notnull_strength="0" exp_strength="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="id" desc="" exp=""/>
    <constraint field="threedi_ids" desc="" exp=""/>
    <constraint field="beginpunt" desc="" exp=""/>
    <constraint field="eindpunt" desc="" exp=""/>
    <constraint field="leidingen" desc="" exp=""/>
    <constraint field="type_leidingen" desc="" exp=""/>
    <constraint field="aantal_leidingen" desc="" exp=""/>
